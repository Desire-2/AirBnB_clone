...
class TestAmenity_instantiation(unittest.TestCase):
    ...
    def testNewInstanceStoredInOjects(self):
    ...
    def testNameIpublicClassAttribute(self):
        am = Amenity()
    ...
    def testTwoAmenitiesDifferentCreated_at(self):
        am1 = Amenity()
        sleep(0.05)
        am2 = Amenity()
        self.assertLess(am1.created_at, am2.created_at)

    def testTwoAmenitiesDifferentUpdated_at(self):
        am1 = Amenity()
        sleep(0.05)
        am2 = Amenity()
