...
class TestBaseModel_instantiation(unittest.TestCase):
    ...
    def test_newInstanceStored_in_objects(self):
        self.assertIn(BaseModel(), models.storage.all().values())

    def test_id_is_publicStr(self):
        self.assertEqual(str, type(BaseModel().id))

    def testCreated_at_is_publicDatetime(self):
        self.assertEqual(datetime, type(BaseModel().created_at))

    def testUpdated_at_is_publicDatetime(self):
    ...
    def testTwoModelsDifferentCreated_at(self):
        bm1 = BaseModel()
        sleep(0.05)
        bm2 = BaseModel()
        self.assertLess(bm1.created_at, bm2.created_at)

    def testTwoModelsDifferentUpdated_at(self):
        bm1 = BaseModel()
        sleep(0.05)
        bm2 = BaseModel()
