...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def testCity_id_isPublicClassAttribute(self):
        pl = Place()
    ...
    def testTwoPlacesDifferentCreated_at(self):
        pl1 = Place()
        sleep(0.05)
        pl2 = Place()
        self.assertLess(pl1.created_at, pl2.created_at)

    def testTwoPlacesDifferentUpdated_at(self):
        pl1 = Place()
        sleep(0.05)
        pl2 = Place()
